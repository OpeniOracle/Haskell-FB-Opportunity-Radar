...
**Four records are now Accepted** — 0004 via D15, 0011 via D23, 0012 via D24, and 0005 in
part via D18 (its time-bounded-ownership corollary; the conservative-resolution ladder
still awaits Gate G-4). The remaining records are Proposed. Earlier revisions were
self-corrections and reconciled external input, not stakeholder supersessions.
